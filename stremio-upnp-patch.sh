...
if any("remoteSubtitle: function" in l for l in L): print("patch 14d: present")
    ...
    NEWN = ('if (!hits.length) return castingUtils.userSubtitleLang(function (lang) { '
